 ...
 *
 * 	Modified to allow multiple pins to be triggered without being 
 *  overriden for both port 0 and port 2.
 */
 ...
 *
 *	Modified to hold all the pins indexes passed instead of overwritten.
 */
