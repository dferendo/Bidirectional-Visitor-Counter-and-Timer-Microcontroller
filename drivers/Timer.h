 ...
 *
 * Modified to reset the timer counter register for timer 0
 * to 0 whenever the IRQHandler is used. This was done 
 * since there was a bug that the first period after a timer
 * interrupt used twice the period passed to trigger. 
 */
#ifndef TIMER_H
#define TIMER_H
